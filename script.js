...
function handlecompare() {
    ...
    if (target==""){
        form2["target"].style.backgroundColor = "red";
        return 
    }
    ...
    if(checkbox.checked) {
        ...
        run = runs
            ...
            outp= "If Team A bats first and gives the target of " + target.toString() + " Then they will have to stop the opposing team in order get their NRR abover Team B before " + run.toString() 
        ...
        totaloverstoball = totaloverstoballs
            ...
            document.getElementById("ifteamabowlfirst").innerHTML = "If Team A bowl first then they will chase the target of " + target.toString() + " in " +parseFloat(calculateBallsToOvers(totaloverstoball)).toString() 
            break;
            } else{
